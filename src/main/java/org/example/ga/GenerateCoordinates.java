...
public class GenerateCoordinates {
    ...
    public static void writeCoordinates2(List<Tower> towers, List<Chromosome2> chromosomes) {
        clear("result.txt");
        List<TowerPlacement> towerPlacements = RecursiveFillingHeuristic2.generateSolution(chromosomes.get(0), towers, container);
        for (int i = 0; i < towerPlacements.size(); i++) {
            TowerPlacement towerPlacement = towerPlacements.get(i);
